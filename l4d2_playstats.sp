...
new     bool:   g_bDiscordWebhookAvailable = false;
...
public OnAllPluginsLoaded()
{
    ...
    g_bDiscordWebhookAvailable = LibraryExists("discord_webhook");
}
public OnLibraryRemoved(const String:name[])
{
    ...
    else if ( StrEqual(name, "discord_webhook") ) { g_bDiscordWebhookAvailable = false; }
}
public OnLibraryAdded(const String:name[])
{
    ...
    else if ( StrEqual(name, "discord_webhook") ) { g_bDiscordWebhookAvailable = true; }
}
